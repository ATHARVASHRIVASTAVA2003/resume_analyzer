...
ID_COLS = []  # No separate ID columns needed since they're included in FEATURES

CATEGORICAL_FEATURES = [
    "payment_method",  # transaction_type -> payment_method
...
NUMERIC_FEATURES = [
    ...
    "transaction_id",  # Can be treated as numeric for ML
    "user_id",       # Can be treated as numeric for ML
]
