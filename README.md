...
### *A Complete Technical Assessment Solution for Fraud Detection Using Synthetic Transaction Data*

<p align="center">
  <strong>End-to-End Fraud Detection System with Explicit Pattern Generation</strong>
</p>

This repository provides a **complete technical assessment solution** that meets all requirements for designing and implementing a fraud detection system using synthetically generated transaction data. The system includes:

✅ **Explicit synthetic data generation with documented fraud patterns**
✅ **Advanced feature engineering for behavioral analysis**
✅ **Temporal and user-level feature creation**
✅ **Comprehensive model evaluation and explainability**
✅ **Production-ready architecture with interactive dashboard**

---

## Executive Summary

## 📊 Fraud Pattern Design

This system implements **5 explicit fraud patterns** based on real-world financial crime:

### 1. Velocity Attacks (30% of fraud)
Multiple rapid transactions within short time windows, simulating account takeover scenarios.

### 2. Amount Spikes (25% of fraud)
Sudden large transactions far exceeding user behavior norms.

### 3. Location Inconsistencies (20% of fraud)
Geographically impossible transaction sequences indicating compromised accounts.

### 4. Shared Device Abuse (15% of fraud)
Same high-risk devices used by multiple user accounts.

### 5. Merchant Rings (10% of fraud)
Coordinated fraudulent activity across related merchants.

**Detailed documentation**: See [docs/fraud_patterns.md](docs/fraud_patterns.md) for comprehensive pattern descriptions, realism justifications, and implementation details.
...
This project fully satisfies the **Fraud Detection Technical Assessment** requirements:

### Part 1: Synthetic Data Generation ✅ COMPLETE
* Custom `generate_data.py` script with explicit fraud pattern injection
* 10,000+ transactions with realistic 4.76% fraud rate
* All required entities (users, merchants, transactions) and fields
* Time-ordered data generation

### Part 2: Fraud Pattern Design ✅ COMPLETE
* **5 Explicit Fraud Patterns** documented in `docs/fraud_patterns.md`:
  * Velocity attacks (30%)
  * Amount spikes (25%)
  * Location inconsistencies (20%)
  * Shared device abuse (15%)
  * Merchant ring patterns (10%)
* Each pattern includes realism justification and detection rationale

### Part 3: Feature Engineering ✅ COMPLETE
* Advanced behavioral features via `advanced_features.py`
* Temporal features via `temporal_features.py`
* User-level pattern analysis
* Device/IP consistency features
* Velocity-based anomaly detection

### Part 4: Model Development ✅ COMPLETE
* RandomForestClassifier with comprehensive justification
* Proper train/test splits and validation
* Cost-sensitive approach (10:1 FN:FP ratio)

### Part 5: Evaluation ✅ COMPLETE
* Precision, Recall, F1, ROC-AUC, Confusion Matrix
* Threshold optimization with business cost analysis
* Detailed performance metrics and trade-off analysis

### Part 6: Explainability ✅ COMPLETE
* SHAP values for global and local explanations
* Interactive Streamlit dashboard with transaction-level insights
* Feature importance visualization

### Part 7: System Design ✅ COMPLETE
* Production-ready pipeline architecture
* Batch and real-time processing capabilities
* Comprehensive monitoring and governance features
...
* **Advanced Feature Engineering** for behavioral pattern detection
...
The dataset is generated using `src/generate_data.py` with explicit fraud pattern injection:

* **10,000+ transactions** with realistic temporal ordering
* **4.76% fraud rate** (500/10,500 transactions)
* **Time-ordered generation** spanning 90-day period
* **Realistic entity relationships** between users, merchants, devices, and IPs

### Advanced Features Engineered

The system creates sophisticated features across multiple dimensions:

**User Behavioral Features** (`src/advanced_features.py`):
* Spending velocity and frequency patterns
* Amount deviation from user baselines
...
* Anomaly detection through statistical methods

**Cross-Entity Features**:
* Device and IP sharing patterns
* Merchant relationship networks
* User risk profiling
...
│   └── fraud_patterns.md       # Detailed fraud pattern documentation
│
├── models/
...
│
├── src/
│   ├── generate_data.py        # ✨ NEW: Synthetic data generation with fraud patterns
│   ├── advanced_features.py    # ✨ NEW: Behavioral and velocity features
│   ├── temporal_features.py    # ✨ NEW: Time-series and user-level features
